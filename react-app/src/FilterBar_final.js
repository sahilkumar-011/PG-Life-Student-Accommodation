...
const FilterBar = props => {
  return (
    <div className="filter-bar row justify-content-around">
      <div className={"col-auto" + (props.currentFilter.gender !== "none" || props.currentFilter.minBudget != null || props.currentFilter.maxBudget != null ? " sort-active" : "")} data-toggle="modal" data-target="#filter-modal">
