...
class App extends Component {
  ...
  updateBudget = (minBudget, maxBudget) => {
    this.setState({
      filter: {
        ...this.state.filter,
        minBudget: minBudget,
  ...
  render() {
    ...
    if (this.state.filter.minBudget !== null && this.state.filter.minBudget !== undefined) {
      properties = properties.filter(property => property.rent >= this.state.filter.minBudget);
    }
    if (this.state.filter.maxBudget !== null && this.state.filter.maxBudget !== undefined) {
      properties = properties.filter(property => property.rent <= this.state.filter.maxBudget);
    }
